...
| `0xCE 0xBE`
| This is where stem:[H_{0}] is stored. We will use this value during decryption to verify that the password submitted by the user is correct.
|===
